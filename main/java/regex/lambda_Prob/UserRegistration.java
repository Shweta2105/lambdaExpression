...
public class UserRegistration {
	...
	public boolean validatePassword(String password) throws InvalidEntryException { // UC8-> UC7-> UC6->UC5 password
																					// validation
		/*
		 * @param password
		 * 
	...
	public boolean validateMobile(String mob) throws InvalidEntryException { // UC4 mobile number validation
		/*
		 * @param mobile
		 * 
		 * @ return boolean
	...
	public boolean validateEmail(String email) throws InvalidEntryException { // UC3 email validation
		/*
		 * @param Email
		 * 
		 * @ return boolean
	...
	public boolean validateLastName(String lastName) throws InvalidEntryException { //UC2 Last name validation
			/*@param Last name
			 * @ return boolean
			 */
	...
	public boolean validateFirstName(String firstName) throws InvalidEntryException { // UC1 firstname validation
